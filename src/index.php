...
require_once __DIR__ . "/interfaces/CombatInterface.php";
require_once __DIR__ . "/Characters/Character.php";
require_once __DIR__ . "/Characters/Berserker.php";
require_once __DIR__ . "/Characters/Mage.php";
require_once __DIR__ . "/Characters/Necromancer.php";
require_once __DIR__ . "/Characters/Monk.php";
require_once __DIR__ . "/Characters/Knight.php";
require_once __DIR__ . "/game/Arena.php";
require_once __DIR__ . "/Exceptions/InsufficientManaException.php";
require_once __DIR__ . "/Exceptions/InvalidEntryException.php";
